...
CALL nouvelEtat('En cours de préparation');
...
-----------------------------------------------------------------------------
--AJOUT DE DONNEES UTILISANT LA PROC RATEPRODUCT--
-----------------------------------------------------------------------------
CALL RATEPRODUCT(1,15,5);
CALL RATEPRODUCT(2,15,5);
CALL RATEPRODUCT(5,15,4);
CALL RATEPRODUCT(1,20,3);
CALL RATEPRODUCT(2,20,5);
CALL RATEPRODUCT(4,20,2);
CALL RATEPRODUCT(9,15,0);
CALL RATEPRODUCT(8,15,4);
CALL RATEPRODUCT(9,20,2);
CALL RATEPRODUCT(8,15,5);
CALL RATEPRODUCT(7,15,4);
CALL RATEPRODUCT(7,20,4);
CALL RATEPRODUCT(6,15,5);